...
export default function RiderOnboarding() {
    ...
    const [runnerValid, setRunnerValid] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-emerald-50 font-sans p-6 flex flex-col items-center justify-center">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border border-emerald-100">

                <div className="bg-emerald-600 p-6 text-center">
                    <h1 className="text-2xl font-black text-white tracking-widest uppercase">GeoRunner Fleet</h1>
                    <p className="text-emerald-100 text-xs mt-1">Neighborhood Delivery Partner Network</p>
                </div>
                ...
                <div className="p-6">
                    {step === 1 && (
                        <div className="space-y-6">
                            <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-200">
                                <p className="text-sm text-emerald-800 font-bold mb-2">Step 1: Identity & Neighborhood Residence</p>
                                <p className="text-xs text-emerald-600">Please upload your Aadhar Card and Address Proof to verify your neighborhood residency (ensuring zero commute distance).</p>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="border-2 border-dashed border-emerald-200 rounded-xl p-4 text-center bg-emerald-50/50">
                                    <span className="text-xs font-bold text-emerald-500">📸 Upload ID Document</span>
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3.5 rounded-xl transition-all shadow-md mt-4 flex justify-center items-center"
                            >
                    ...
                    {step === 2 && (
                        <div className="space-y-6 text-center">
                            ...
                            <p className="text-sm text-neutral-500">Your neighborhood residency is verified. You are now authorized to accept local neighborhood deliveries with guaranteed zero-commission structural payouts.</p>
